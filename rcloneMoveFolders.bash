...
#             # echo "$j"
#             # echo "rclone move \"Blomp-Banee-Gmail-Drive:"$i2/$j"\" \"Blomp-Banee-Gmail-Drive:"$i2 VMware/$j"\" --dry-run"
#             # rclone move "Blomp-Banee-Gmail-Drive:$i2/$j" "Blomp-Banee-Gmail-Drive:VMware Images/$i2 VMware/$j" --delete-before --dry-run --log-level DEBUG
#             rclone move "Blomp-Banee-Gmail-Drive:$i2/$j" "Blomp-Banee-Gmail-Drive:VMware Images/$i2 VMware/$j" --delete-before
#         done
#     fi
# done
