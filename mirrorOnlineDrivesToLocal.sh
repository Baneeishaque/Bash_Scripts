...
rclone sync EShopees-SFTP:/var/www/ Data/Misc/Baneeishaque5-GDrive/To_DK/EShopees-var-www/ --progress --progress-terminal-title --human-readable --filter-from Data/Labs/Lab_Banee/rclone/EShopees-SFTP-filter.txt --dry-run
echo rclone check EShopees-SFTP:/var/www/ Data/Misc/Baneeishaque5-GDrive/To_DK/EShopees-var-www/ --progress --progress-terminal-title --human-readable --filter-from Data/Labs/Lab_Banee/rclone/EShopees-SFTP-filter.txt --differ Data/Labs/Lab_Banee/rclone/EShopees-SFTP-differ.txt --error Data/Labs/Lab_Banee/rclone/EShopees-SFTP-error.txt --missing-on-dst Data/Labs/Lab_Banee/rclone/EShopees-SFTP-missing-on-dst.txt --missing-on-src Data/Labs/Lab_Banee/rclone/EShopees-SFTP-missing-on-src.txt
...
rclone sync Data/Misc/Mega-Banee3-Gmail-Drive/ Mega-Banee3-Gmail: --progress --progress-terminal-title --human-readable --dry-run
rclone sync Mega-Banee4-Gmail: Data/Misc/Mega-Banee4-Gmail-Drive/ --progress --progress-terminal-title --human-readable --dry-run
...
rclone sync Storj-Banee-Gmail: Data/Misc/Storj-Banee-Gmail-Drive/ --progress --progress-terminal-title --human-readable --dry-run
echo Wozi Local++
rclone sync Wozi-info-tech-com: Data/Misc/Wozi-info-tech-com-root/ --progress --progress-terminal-title --human-readable --filter-from Data/Labs/Lab_Banee/rclone/Wozi-info-tech-com-root-filter.txt --dry-run
echo rclone check Wozi-info-tech-com: Data/Misc/Wozi-info-tech-com-root/ --progress --progress-terminal-title --human-readable --filter-from Data/Labs/Lab_Banee/rclone/Wozi-info-tech-com-root-filter.txt --differ Data/Labs/Lab_Banee/rclone/Wozi-info-tech-com-differ.txt --error Data/Labs/Lab_Banee/rclone/Wozi-info-tech-com-error.txt --missing-on-dst Data/Labs/Lab_Banee/rclone/Wozi-info-tech-com-missing-on-dst.txt --missing-on-src Data/Labs/Lab_Banee/rclone/Wozi-info-tech-com-missing-on-src.txt
